...
activities = {
    ...
    "Science Club": {
        ...
        "max_participants": 12,
        "participants": ["jackson@mergington.edu", "hannah@mergington.edu"]
    },
    "Robotics Team": {
        "description": "Design and build robots to compete in challenges",
...
"Chess Club": {
    ...
    "Basketball Team": {
        "description": "Practice basketball skills and play in competitive games",
